...
<body class="testing">
    <a class="testing-arrow-up testing-scroll-up"><span class="ti-angle-up"></span></a>
    <header>
        <div class="g-container">
            <h1 class="g-text-center">Global Style Guide</h1>
        </div>
    </header>
    <div class="g-container">
        <div class="testing-sidebar">
            <div class="testing-sidebar-inner">
                <ul class="testing-menu">
                    ...
                    <li><a class="test-scroll" scroll="#icons">Icons</a></li>
                    <li><a class="test-scroll" scroll="#links">Links</a></li>
                    <li><a class="test-scroll" scroll="#buttons">Buttons</a></li>
                    <li><a class="test-scroll" scroll="#colours">Colours</a></li>
                    ...
                    <li><a class="test-scroll" scroll="#image-gallery">Image Gallery</a></li>
...
<p class="g-font-size-largest">Largest body font</p></xmp></pre>
            ...
            <hr>
            <p>Themify Icon Font. See <a target="_blank" href="https://themify.me/themify-icons">https://themify.me/themify-icons</a> for information.</p>
            ...
            <div class="testing-dark-bg" style="padding: 10px 15px; width: 100%;">
...
<br><br>
<a class="g-btn g-btn-lg">Large Button</a>
<a class="g-btn g-btn-sm">Small Button</a></xmp></pre>
            ...
            <a class="g-btn g-active g-btn-quaternary">Quaternary State</a>
            <a class="g-btn g-btn-quaternary g-disabled">Disabled</a>
            <br><br>
            <div class="testing-dark-bg" style="padding: 10px 15px; width: 100%;">
                <a class="g-btn g-btn-light">Light Button</a>
                <a class="g-btn g-active g-btn-light">Light Button Active State</a>
                <a class="g-btn g-btn-light g-disabled">Disabled</a>
            </div>

<pre><xmp><a class="g-btn g-btn-secondary">Secondary Button</a>
<a class="g-btn g-active g-btn-secondary">Active State</a>
<a class="g-btn g-btn-secondary g-disabled">Disabled</a>
<br><br>
<a class="g-btn g-btn-tertiary">Tertiary Button</a>
...
<div class="testing-dark-bg" style="padding: 10px 15px; width: 100%;">
    ...
    <a class="g-btn g-btn-light g-disabled">Disabled</a>
            ...
            <a class="g-btn">Button with icon<span class="ti-close g-icon-right"></span></a>
            <a class="g-btn g-btn-quaternary"><span class="ti-check g-icon-left"></span>Button with icon left</a>
            <br>
            <br>
            <a class="g-btn g-btn-icon"><span class="ti-menu"></span></a>
            <a class="g-btn g-btn-tertiary g-btn-icon"><span class="ti-close"></span></a>

<pre><xmp><div class="testing-dark-bg" style="padding: 10px 15px; width: 100%;">
    <a class="g-btn g-btn-light">Light Button</a>
    <a class="g-btn g-active g-btn-light">Light Button Active State</a>
    <a class="g-btn g-btn-light g-disabled">Disabled</a>
</div>
...
<br>
<a class="g-btn g-btn-icon"><span class="ti-menu"></span></a>
<a class="g-btn g-btn-tertiary g-btn-icon"><span class="ti-close"></span></a></xmp></pre>
    ...
    <a class="g-btn btn-secondary">Toggle Off</a>
            ...
            <div class="line margin-bottom">
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-primary"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-secondary"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-tertiary"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-quaternary"></div>
                </div>
            </div>
            ...
            <div class="line margin-bottom">
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-primary-1"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-primary-2"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-primary-3"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-primary-4"></div>
                </div>
            </div>
            ...
            <div class="line margin-bottom">
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-grey-1"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-grey-2"></div>
                </div>
                <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-grey-3"></div>
                </div>
                 <div class="unit size1of4">
                    <div class="testing-bg g-bg-color-color-grey-4"></div>
                </div>
            </div>
...
<pre><xmp><div class="g-pagination">
    ...
    <a class="g-next"><span class="fa fa-angle-right"></span></a>
            ...
            <hr> 
            <p>Built off of fancyBox, see <a href="http://fancyapps.com/fancybox/" target="_blank">http://fancyapps.com/fancybox/</a> for documentation.</p>
            <div class="line no-gutter">
                <div class="size1of4 sm-size1of2 xs-size1of2 unit">
                    <a style="background: url(http://farm1.staticflickr.com/313/19831416459_5ddd26103e_m.jpg) center center; background-size: cover; height: 100px; width: 100%; display: block;" class="fancybox" rel="gallery1" href="http://farm1.staticflickr.com/313/19831416459_5ddd26103e_b.jpg" title="Sgwd Ddwli Uchaf, Brecon Waterfalls (technodean2000)">

                    </a>
                </div>
                <div class="size1of4 sm-size1of2 xs-size1of2 unit">
                    <a style="background: url(http://farm6.staticflickr.com/5444/17679973232_568353a624_m.jpg) center center; background-size: cover; height: 100px; width: 100%; display: block;" class="fancybox" rel="gallery1" href="http://farm6.staticflickr.com/5444/17679973232_568353a624_b.jpg" title="Sgwd Ddwli Uchaf, Brecon Waterfalls (technodean2000)">

                    </a>
                </div>
                <div class="size1of4 sm-size1of2 xs-size1of2 unit">
                    <a style="background: url(http://farm8.staticflickr.com/7367/16426879675_e32ac817a8_m.jpg) center center; background-size: cover; height: 100px; width: 100%; display: block;" class="fancybox" rel="gallery1" href="http://farm8.staticflickr.com/7367/16426879675_e32ac817a8_b.jpg" title="Sgwd Ddwli Uchaf, Brecon Waterfalls (technodean2000)">

                    </a>
                </div>
                <div class="size1of4 sm-size1of2 xs-size1of2 unit">
                    <a style="background: url(http://farm6.staticflickr.com/5612/15344856989_449794889d_m.jpg) center center; background-size: cover; height: 100px; width: 100%; display: block;" class="fancybox" rel="gallery1" href="http://farm6.staticflickr.com/5612/15344856989_449794889d_b.jpg" title="Sgwd Ddwli Uchaf, Brecon Waterfalls (technodean2000)">
